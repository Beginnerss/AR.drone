...
@SuppressLint("NewApi")
public class ControlDroneActivity2
    ...
    private static final int UPDATA_TV = 3;
    ...
    private boolean whethertakeoff = false;
    private int avoidbarrier = 9;
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case UPDATA_TV:
                    tv_blue.setText(String.valueOf(data));
                    break;
            }
        }
    };
...
//            forceCombinedControlMode = false;
        ...
        btn_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                    ...
                    // System.out.println("--------------------" + rowX + ":" + rowY);
                    droneControlService.setProgressiveCommandEnabled(true);
                    running = true;
                    //droneControlService.setDeviceOrientation(0, 0);
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            //System.out.println("向左飞按下");
                            break;
                        case MotionEvent.ACTION_MOVE:
                            // System.out.println("向左飞移动");
                            // flyOrientation(0.281f, 0.078f);
                            flyOrientation(-0.665F, 0.005f);
//                        droneControlService.setPitch(0);
//                        droneControlService.setRoll(0.5f);
                            break;
                        case MotionEvent.ACTION_UP:
                            //System.out.println("向左飞抬起");
                            // flyOrientation(-0.015f, -0.017f);
//                        droneControlService.setPitch(0);
//                        droneControlService.setRoll(0);
        ...
        btn_right.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                    ...
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            //System.out.println("向右飞按下");
                            break;
                        case MotionEvent.ACTION_MOVE:
                            //System.out.println("向右飞移动");
                            flyOrientation(0.665f, -0.002f);
//                        droneControlService.setPitch(0);
//                        droneControlService.setRoll(-0.5f);
                            break;
                        case MotionEvent.ACTION_UP:
                            // System.out.println("向右飞抬起");
                            //flyOrientation(-0.015f, -0.017f);
//                        droneControlService.setPitch(0);
//                        droneControlService.setRoll(0);
                            droneControlService.setProgressiveCommandEnabled(false);
        ...
        btn_forward.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                    ...
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // System.out.println("向前飞按下");
                            break;
                        case MotionEvent.ACTION_MOVE:
                            //System.out.println("向前飞移动");
                            //flyOrientation(0.005f, -0.665f);
                            flyOrientation(-0.015f, 0.665f);
//                        droneControlService.setPitch(0.5f);
//                        droneControlService.setRoll(0);
                            break;
                        case MotionEvent.ACTION_UP:
                            //System.out.println("向前飞抬起");
                            //flyOrientation(-0.015f, -0.017f);
//                        droneControlService.setPitch(0);
//                        droneControlService.setRoll(0);
                            droneControlService.setProgressiveCommandEnabled(false);
        ...
        btn_backward.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                    ...
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // System.out.println("向后飞按下");
                            break;
                        case MotionEvent.ACTION_MOVE:
                            //System.out.println("向后飞移动");
                            //flyOrientation(-0.015f, 0.665f);
                            flyOrientation(0.005f, -0.665f);
//                        droneControlService.setPitch(-0.5f);
//                        droneControlService.setRoll(0);
...
//                        droneControlService.setRoll(0);
     ...
     * @param y 左右
     */
    public void flyOrientation(float x, float y) {
    ...
    public void myInitFly(View view) {
        if (droneControlService != null) {
            //droneControlService.setRoll(0.5f);
            // droneControlService.setPitch(0.5f);
            droneControlService.turnLeft(0.5f);
    ...
    //起飞降落
    public void myTakeOff(View view) {
        //Toast.makeText(this, "起飞", Toast.LENGTH_SHORT).show();
        if (droneControlService != null) {
            droneControlService.triggerTakeOff();
            whethertakeoff = true;
        }
    ...
    //Arduino壁障控制
    public void myArduinoControlFly(View view) {
        ...
        if (pairedDevices.size() > 0) {
            ...
            for (BluetoothDevice device : pairedDevices) {
                ...
                try {
                    mBluetoothsocket = mDevice.createRfcommSocketToServiceRecord(UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"));
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    data = (char) buffer[0];
                    handler.sendEmptyMessage(UPDATA_TV);
                    System.out.println((char) buffer[0]);
                    //蔽障判断
                    if (whethertakeoff = true) {
                        if ((char) buffer[0] == '0') {//向左飞
                            //System.out.println("向左飞行");
                            //avoidbarrier = 0;
                            droneControlService.setProgressiveCommandEnabled(true);
                            running = true;
                            flyOrientation(0.365f, -0.002f);
                        }
                        if ((char) buffer[0] == '5') {//向左慢飞
                            //avoidbarrier = 0;
                            // System.out.println("向左缓慢飞行");
                            droneControlService.setProgressiveCommandEnabled(true);
                            running = true;
                            flyOrientation(0.165f, -0.002f);
                        }
                        if ((char) buffer[0] == '3') {//向后飞
                            //avoidbarrier = 3;
                            // System.out.println("向后飞行");
                            droneControlService.setProgressiveCommandEnabled(true);
                            running = true;
                            flyOrientation(0.015f, -0.365f);
                        }
                        if ((char) buffer[0] == '8') {//向后慢飞
                            //avoidbarrier = 3;
                            // System.out.println("向后缓慢飞行");
                            droneControlService.setProgressiveCommandEnabled(true);
                            running = true;
                            flyOrientation(0.015f, -0.165f);
                        }
                        if ((char) buffer[0] == '2') {//向右飞
                            //avoidbarrier = 2;
                            // System.out.println("向右飞行");
                            droneControlService.setProgressiveCommandEnabled(true);
                            running = true;
                            flyOrientation(-0.365F, 0.005f);
                        }
                        if ((char) buffer[0] == '7') {//向右慢飞
                            //avoidbarrier = 2;
                            //System.out.println("向右缓慢飞行");
                            droneControlService.setProgressiveCommandEnabled(true);
                            running = true;
                            flyOrientation(-0.165F, 0.005f);
                        }
                        if ((char) buffer[0] == '1') {//向前飞
                            //avoidbarrier = 1;
                        ...
                        if ((char) buffer[0] == '6') {//向前慢飞
                            //avoidbarrier = 1;
                            //System.out.println("向前缓慢飞行");
                            droneControlService.setProgressiveCommandEnabled(true);
                            running = true;
                            flyOrientation(-0.015f, 0.165f);
                        }
//                    if((char)buffer[0] == '8'){//飞行释放
//
//                    }
                        if ((char) buffer[0] == '9') {//无飞行指令
                            //avoidbarrier = 9;
                            droneControlService.setProgressiveCommandEnabled(false);
                            running = false;
                        }
    ...
    /*//向左飞行
    public void myLeftFly(View view) {
        if (droneControlService != null) {
            //droneControlService.setRoll(0.5f);
            //droneControlService.requestConfigUpdate();
            //droneControlService.moveLeft(0.99f);
            //droneControlService.turnRight(0.5f);
            droneControlService.setProgressiveCommandEnabled(true);
            droneControlService.setPitch(0);
            droneControlService.setRoll(0.5f);
    ...
    //向右飞行
    public void myRightFly(View view) {
        if (droneControlService != null) {
            droneControlService.setRoll(0.5f);
            droneControlService.requestConfigUpdate();
            droneControlService.moveRight(0.99f);

        }
    }
    //向前飞行
    public void myForwardFly(View view) {
        if (droneControlService != null) {
            droneControlService.setPitch(0.5f);
            droneControlService.requestConfigUpdate();
            droneControlService.moveForward(0.99f);
        }
    }
    //向后飞行
    public void myBackwardFly(View view) {
        if (droneControlService != null) {
            droneControlService.setPitch(0.5f);
            droneControlService.requestConfigUpdate();
            droneControlService.moveBackward(0.99f);
        }
    }*/
}
