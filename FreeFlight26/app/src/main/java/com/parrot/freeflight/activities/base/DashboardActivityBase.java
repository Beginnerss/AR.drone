...
import com.parrot.freeflight.activities.ControlDroneActivity2;
...
MediaStorageReceiverDelegate
{
	...
	private CheckedTextView btn_mycontrol;
    ...
    private void initUI() 
	{
		...
		btn_mycontrol = (CheckedTextView) findViewById(R.id.btn_mycontrol);
	}
	...
	private void initListeners()
	{
		...
		btn_mycontrol.setOnClickListener(this);
	}
	...
	public void onClick(View v)
	{
		switch (v.getId())
		{
			...
			case R.id.btnGetYourDrone:
				...
				break;
			case R.id.btn_mycontrol:
				startActivity(new Intent(this, ControlDroneActivity2.class));
				break;
		}
	}
